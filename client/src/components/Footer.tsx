...
export default function Footer() {
  ...
  return (
    <footer
      id="contacto"
      className="section-paper bg-footer pt-12 sm:pt-16 pb-8 bg-gray-600 text-[#FFF9F5]"
    >
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 mb-10 md:mb-12">
          ...
          <div>
            ...
            <div className="flex items-start gap-2 text-base sm:text-lg leading-relaxed opacity-90">
              <span className="text-xl sm:text-2xl mt-1" aria-hidden="true">📍</span>
              <div>
                <p>Punta Arenas</p>
        ...
        <div className="text-center mb-10 md:mb-12 max-w-2xl mx-auto">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block font-bold py-3 px-8 rounded-full text-base sm:text-lg transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1 bg-[#F4C7D4] text-gray-600"
